    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Emoji background
          Positioned(
            top: -20.h,  // Example: using Sizer for top position
            right: 12.5.w,  // Example: using Sizer for right position
            child: Opacity(
              opacity: 1,
              child: Image.asset('assets/lightsmile.png', width: 75.w, height: 37.5.h),
            ),
          ),
          Positioned(
            top: 2.h,  // Example: using Sizer for top position
            right: -15.w,  // Example: using Sizer for right position
            child: Transform.rotate(
              angle: -0.5, // Adjust the angle as needed
              child: Opacity(
                opacity: 1,
                child: Image.asset('assets/lightsmile.png', width: 42.5.w, height: 42.5.h),
              ),
            ),
          ),
          // Main content
